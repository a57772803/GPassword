...
let icon1: HTMLElement = document.getElementById("icon1")!;
let menu1: HTMLElement = document.getElementById("menu1")!;
const showMenu1 = (flag: any) => {
    if (flag) {
...
let open: HTMLElement = document.getElementById("open")!;
let close: HTMLElement = document.getElementById("close")!;

const showNav = (flag: any) => {
    if (flag) {
        ...
        <div id="Main"
            ...
            <div class="hidden xl:flex justify-start p-6 items-center space-x-3">
                ...
                <router-link to="/login">
                    <p class="text-2xl leading-6 text-white"> OvonRueden
                    </p>
                </router-link>
            </div>
            <div
